...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 13. Sep 2015 um 18:18
...
--
ALTER TABLE `instances`
  MODIFY `instanceid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=59;
--
...
--
ALTER TABLE `sessions`
  MODIFY `sessionid` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
