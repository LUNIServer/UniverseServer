...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 14. Sep 2015 um 16:00
...
CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `health` int(10) NOT NULL DEFAULT '5'
  `maxHealth` float NOT NULL DEFAULT '5.0'
) ENGINE=MyISAM AUTO_INCREMENT=1152921504606847024 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=MyISAM AUTO_INCREMENT=1236 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=MyISAM AUTO_INCREMENT=1152921510794155124 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `characters`
  MODIFY `objectID` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1152921504606847024;
--
...
--
ALTER TABLE `instances`
  MODIFY `instanceid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `objects`
  MODIFY `objectid` bigint(64) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1152921510794155124;
--
-- AUTO_INCREMENT für Tabelle `sessions`
--
ALTER TABLE `sessions`
  MODIFY `sessionid` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
