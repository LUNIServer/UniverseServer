...
void Component3::writeToPacket(RakNet::BitStream *packet, REPLICA_PACKET_TYPE packetType) {
...
unsigned int Component3::getComponentID(){ return 3; }

bool Component3::getFlag1(){ return this->flag1; }
int Component3::getData1(){ return this->data1; }
bool Component3::getFlag2(){ return this->flag2; }
int Component3::getData2_1(){ return this->data2_1; }
int Component3::getData2_2(){ return this->data2_2; }
int Component3::getData2_3(){ return this->data2_3; }
int Component3::getData2_4(){ return this->data2_4; }
int Component3::getData2_5(){ return this->data2_5; }
int Component3::getData2_6(){ return this->data2_6; }
bool Component3::getFlag3(){ return this->flag3; }
int Component3::getData3(){ return this->data3; }
bool Component3::getFlag4(){ return this->flag4; }
COMPONENT3_POSITION Component3::getPosition(){ return this->position; }
COMPONENT3_ROTATION Component3::getRotation(){ return this->rotation; }

void Component3::setFlag1(bool flag1){ this->flag1 = flag1; }
void Component3::setData1(int data1){ this->data1 = data1; }
void Component3::setFlag2(bool flag2){ this->flag2 = flag2; }
void Component3::setData2_1(int data2_1){ this->data2_1 = data2_1; }
void Component3::setData2_2(int data2_2){ this->data2_2 = data2_2; }
void Component3::setData2_3(int data2_3){ this->data2_3 = data2_3; }
void Component3::setData2_4(int data2_4){ this->data2_4 = data2_4; }
void Component3::setData2_5(int data2_5){ this->data2_5 = data2_5; }
void Component3::setData2_6(int data2_6){ this->data2_6 = data2_6; }
void Component3::setFlag3(bool flag3){ this->flag3 = flag3; }
void Component3::setData3(int data3){ this->data3 = data3; }
void Component3::setFlag4(bool flag4){ this->flag4 = flag4; }
void Component3::setPosition(COMPONENT3_POSITION position){ this->position = position; }
void Component3::setRotation(COMPONENT3_ROTATION rotation){ this->rotation = rotation; }
...
void Component40::writeToPacket(RakNet::BitStream *packet, REPLICA_PACKET_TYPE packetType) {
	packet->Write(flag1);
	if (flag1) {
...
unsigned int Component40::getComponentID() {
	return 40;
}

bool Component40::getFlag1(){ return this->flag1; }
COMPONENT40_POSITION Component40::getPosition(){ return this->pos; }
COMPONENT40_ROTATION Component40::getRotation(){ return this->rot; }
bool Component40::getFlag2(){ return this->flag2; }
bool Component40::getFlag3(){ return this->flag3; }
COMPONENT40_DATA1 Component40::getData1(){ return this->data1; }
bool Component40::getFlag4_1(){ return this->flag4_1; }
COMPONENT40_DATA2 Component40::getData2(){ return this->data2; }
bool Component40::getFlag4_2(){ return this->flag4_2; }
COMPONENT40_DATA3 Component40::getData3(){ return this->data3; }

void Component40::setFlag1(bool flag1){ this->flag1 = flag1; }
void Component40::setPosition(COMPONENT40_POSITION position){ this->pos = position; }
void Component40::setRotation(COMPONENT40_ROTATION rotation){ this->rot = rotation; }
void Component40::setFlag2(bool flag2){ this->flag2 = flag2; }
void Component40::setData1(COMPONENT40_DATA1 data1){ this->flag3 = true; this->data1 = data1; }
void Component40::setData2(COMPONENT40_DATA2 data2){ this->flag4_1 = true; this->data2 = data2; }
void Component40::setData3(COMPONENT40_DATA3 data3){ this->flag4_2 = true; this->data3 = data3; }
...
std::vector<long> *Component7::getData4_1Ref(){ this->flag4 = true; return &this->data4_1; }
...
long Component17::getData2(){
	return this->data2;
}

void Component17::setData2(long d2){
	this->data2 = d2;
}
...
long Component17::equipItem(long long objid, long lot, ushort slot, long d6Data, bool retrieveData) {
	if (lot > -1) {
		COMPONENT17_EQUIPMENT eqi;
		eqi.objid = objid;
		eqi.lot = lot;
...
void Component5::writeToPacket(RakNet::BitStream *packet, REPLICA_PACKET_TYPE packetType) {
	packet->Write(flag1);
}

unsigned int Component5::getComponentID(){ return 5; }

bool Component5::getFlag1(){ return this->flag1; }
void Component5::setFlag1(bool flag1){ this->flag1 = flag1; }
...
void Component16::writeToPacket(RakNet::BitStream *packet, REPLICA_PACKET_TYPE packetType) {
	packet->Write(flag1);
	if (flag1) {
		packet->Write(flag1_1);
...
unsigned int Component16::getComponentID() {
	return 16;
}

bool Component16::getFlag1(){ return this->flag1; }
bool Component16::getFlag1_1(){ return this->flag1_1; }
bool Component16::getFlag1_2(){ return this->flag1_2; }

void Component16::setFlag1(bool flag1){ this->flag1 = flag1; }
void Component16::setFlag1_1(bool flag1_1){ this->flag1_1 = flag1_1; }
void Component16::setFlag1_2(bool flag1_2){ this->flag1_2 = flag1_2; }
